                ...
                <form action="{{ route('payment.store') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="payment_method_name" id="payment_method_name"
                            ...
                            focus:outline-none transition-all duration-200 @error('payment_method_name') @enderror"
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                            ...
                            text-white rounded-lg font-semibold hover:from-[#003e9b] hover:to-[#002b70]
