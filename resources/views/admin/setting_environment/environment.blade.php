        ...
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    {{-- Header --}}
                    <div class="bg-gradient-to-b from-[#003A8F] to-[#002766] px-6 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('payment.create') }}"
                                class="inline-flex items-center gap-2 px-4 py-2 bg-white text-blue-600 rounded-lg text-sm font-semibold hover:bg-emerald-50 transition-colors shadow-sm">
                        ...
                        @if (count($payment_method) > 0)
                            <div class="space-y-3">
                                @foreach ($payment_method as $payment)
                                    <div
                                        class="group bg-gray-50 hover:bg-blue-50 rounded-lg p-4 border border-gray-200 hover:border-blue-300 transition-all duration-200">
                                        <div class="flex items-start justify-between gap-4">
                                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                                <div
                                                    class="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center font-bold text-sm">
                                                    {{ $no++ }}
                                                </div>
                                                <div class="flex-1 min-w-0">
                                                    <div class="flex gap-2 items-center">
                                                        ...
                                                        <div
                                                            class="flex flex-wrap gap-2 mb-2 text-blue-500 text-xs font-medium">
                    ...
                    <div class="bg-gradient-to-b from-[#003A8F] to-[#002766] px-6 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('funding.create') }}"
                                class="inline-flex items-center gap-2 px-4 py-2 bg-white text-blue-600 rounded-lg text-sm font-semibold hover:bg-amber-50 transition-colors shadow-sm">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 4v16m8-8H4" />
                                </svg>
                                            ...
                                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <div class="flex gap-2">
                                                        ...
                                                        <div
                                                            class="flex flex-wrap gap-2 mb-2 text-blue-700 text-xs font-medium">
