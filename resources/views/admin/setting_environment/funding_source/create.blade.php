<x-app-layout>
    ...
    {{-- TOMBOL KEMBALI --}}
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4 py-2">
                ...
                <form action="{{ route('funding.store') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="funding_source_name" id="funding_source_name"
                            ...
                            focus:outline-none transition-all duration-200 @error('funding_source_name') @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" name="sub_category" id="sub_category"
                            class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-800 font-medium
                            placeholder-gray-400 focus:ring-2
                            focus:outline-none transition-all duration-200 @error('sub_category') @enderror"
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-800 font-medium
                            placeholder-gray-400 focus:ring-2
                            focus:outline-none transition-all duration-200 @error('description')  @enderror"
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-b from-[#003A8F] to-[#002766]
                            text-white rounded-lg font-semibold hover:from-[#013d98] hover:to-[#012d74]
