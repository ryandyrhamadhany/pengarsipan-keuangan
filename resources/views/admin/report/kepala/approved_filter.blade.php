<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight">
            {{ __('Laporan semua pengajuan yang sudah dibuat') }}
        </h2>
    </x-slot>

    <div class="py-6 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            <a href="{{ route('report.administrator') }}"
                class="inline-flex mb-4 items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-md border border-gray-200 hover:bg-gray-200 transition-colors">
                ...
                <div class="p-4 space-y-4">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-md border border-gray-200">
                            ...
                            <form method="GET" action="{{ route('report.administrator.kepala.approved') }}"
                                ...
                                <button type="submit" formaction="{{ route('kepala.report_approved') }}"
                                    formtarget="_blank"
                                    class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-md transition-colors duration-200 flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="space-y-3">
                                ...
                                @empty
                                    <div class="text-center py-12 bg-gray-50 rounded-md">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">Pengajuan yang Anda buat akan muncul di
                                            sini</p>
                                    </div>
                                @endforelse
                            </div>
