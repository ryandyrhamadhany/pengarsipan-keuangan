<x-app-layout>
    ...
    <div class="py-6 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            ...
            {{-- WELCOME CARD --}}
            <div
                class="relative overflow-hidden bg-gradient-to-b from-[#003A8F] to-[#002766] text-white p-10 rounded-2xl shadow-md mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                ...
                {{-- Jumlah Arsip --}}
                <div
                    class="group relative p-8 bg-white shadow-md rounded-2xl transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-start justify-between">
                        ...
                        <div
                            class="p-4 bg-purple-100 rounded-xl group-hover:bg-purple-500 transition-colors duration-300">
                ...
                <div
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div
                            class="p-4 bg-orange-100 rounded-xl group-hover:bg-orange-500 transition-colors duration-300">
                ...
                <div
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500 uppercase tracking-wide">Jumlah Pengguna</p>
                            <h3 class="text-4xl font-extrabold text-gray-800 mt-3">
                                {{ $akun }}
                            </h3>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-md">
                {{-- Section Header --}}
                <div class="flex items-center justify-between pb-3 border-b-2 border-gray-200 mb-4">
                ...
                <div class="space-y-3">
                    @forelse ($arsiplist as $ar)
                        <div
                            ...
                            {{-- Action Button --}}
                            <a href="{{ route('digital.show', $ar->id) }}"
                                class="flex-shrink-0 ml-4 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-300 shadow-md hover:shadow-xl flex items-center">
