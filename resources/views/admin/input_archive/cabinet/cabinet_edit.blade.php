        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white shadow-md sm:rounded-xl p-6 border border-gray-200">
                    ...
                    <form action="{{ route('cabinet.update', $cabinet->id) }}" method="POST" class="space-y-6">
                        @method('PUT')
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="{{ $cabinet->cabinet_code }}"
                                class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm"
                        ...
                        <div>
                            ...
                            <input type="text" name="deskripsi" id="deskripsi" value="{{ $cabinet->deskripsi }}"
                                class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm"
