                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <input type="text" 
                                       name="name" 
                                       id="name"
                                       class="w-full px-5 py-2 border-2 border-gray-200 rounded-lg focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 bg-gray-50 focus:bg-white pl-12"
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <input type="text" 
                                       name="code" 
                                       id="code"
                                       class="w-full px-5 py-2 border-2 border-gray-200 rounded-lg focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 bg-gray-50 focus:bg-white pl-12 uppercase"
                            ...
                            <div class="mt-2 flex items-start gap-2 p-1 bg-yellow-50 border border-yellow-200 rounded-lg">
