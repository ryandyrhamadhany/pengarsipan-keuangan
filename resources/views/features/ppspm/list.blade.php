                    ...
                    <div>
                        <div class="p-2 bg-yellow-100 border-2 border-yellow-500 rounded-md mb-4">
                            ...
                            <div class="text-xs text-yellow-600">
                                Silahkan cari dokumen yang diinginkan dengan menggunakan kata kunci misalkan kata kunci
                                <strong>Gaji</strong> contohnya: <strong>Gaji</strong> Divisi Program April 2026
                            </div>
                        </div>
                ...
                <div class="space-y-3">
                    ...
                    @forelse ($my_proses as $proses)
                        <div
                            ...
                            {{-- KONTEN LIST --}}
                            <a href="{{ route('verify.item.ppspm', $proses->id) }}" class="flex-1 px-4">
                                {{-- Nama Pengajuan --}}
                                ...
                                <div class="text-xs text-gray-500 mb-2">
                                    Diajukan oleh: <span
                                        class="font-medium text-gray-700">{{ $proses->user->name }}</span>
                                </div>
                                <div class="text-xs text-gray-500 mb-2">
                ...
                <div class="space-y-3">
                    ...
                    @forelse ($pengajuans as $all)
                        <div
                            ...
                            {{-- KONTEN LIST --}}
                            <a href="{{ route('verify.item.ppspm', $all->id) }}" class="flex-1 px-4">
                                {{-- Nama Pengajuan --}}
                                <div class="font-semibold text-gray-800 mb-2">
                                ...
                                <div class="text-xs text-gray-500 mb-2">
                                    Diajukan oleh: <span
                                        class="font-medium text-gray-700">{{ $all->user->name }}</span>
                                </div>
                                <div class="text-xs text-gray-500 mb-2">
