                        ...
                        @if ($sign->requirements_status == 'Lengkap' && $sign->verification_status == 1)
                            <div class="group mb-4 last:mb-0">
                                <div
                                    ...
                                    {{-- KONTEN LIST --}}
                                    <a href="{{ route('verify.item.bendahara', $sign->id) }}" class="flex-1 px-5">
                                        {{-- Nama Pengajuan --}}
                                        ...
                                        <div class="text-xs text-gray-600 mb-3">
                                            Diajukan oleh: <span
                                                class="font-medium text-gray-800">{{ $sign->user->name }}</span>
                                        </div>

                                        <div class="text-xs text-gray-600 mb-3">
                                            divisi: <span
                                                class="font-medium text-gray-800">{{ $sign->user->role }}</span>
                                        </div>
                        ...
                        @if ($pengajuan->requirements_status == 'Lengkap' && $pengajuan->verification_status == 1)
                            <div class="group mb-4 last:mb-0">
                                <div
                                    ...
                                    {{-- KONTEN LIST --}}
                                    <a href="{{ route('verify.item.bendahara', $pengajuan->id) }}"
                                        class="flex-1 px-5">
                                        {{-- Nama Pengajuan --}}
                                        <div class="font-semibold text-base text-gray-900 mb-2">
                                        ...
                                        <div class="text-xs text-gray-600 mb-3">
                                            divisi: <span
                                                class="font-medium text-gray-800">{{ $pengajuan->user->role }}</span>
                                        </div>
