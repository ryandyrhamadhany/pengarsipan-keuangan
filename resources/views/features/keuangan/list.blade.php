                ...
                <div class="space-y-3">
                    ...
                    @forelse ($my_proses as $proses)
                        <div
                            ...
                            {{-- KONTEN LIST --}}
                            <a href="{{ route('verify.item.keuangan', $proses->id) }}" class="flex-1 px-4">
                                {{-- Nama Pengajuan --}}
                ...
                <div class="space-y-3">
                    ...
                    @forelse ($not_check_submit as $submit)
                        <div
                            ...
                            {{-- KONTEN LIST --}}
                            <a href="{{ route('verify.item.keuangan', $submit->id) }}" class="flex-1 px-4">
                                {{-- Nama Pengajuan --}}
                                <div class="font-semibold text-gray-800 mb-2">
                ...
                <div class="space-y-3">
                    ...
                    @forelse ($all_submit as $all)
                        <div
                            ...
                            {{-- KONTEN LIST --}}
                            <a href="{{ route('verify.item.keuangan', $all->id) }}" class="flex-1 px-4">
                                {{-- Nama Pengajuan --}}
                                <div class="font-semibold text-gray-800 mb-2">
