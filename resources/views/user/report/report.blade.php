                ...
                <div class="p-8 space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-md border border-gray-200">
                            ...
                            <form method="GET" action="{{route('user.report')}}" class="flex flex-wrap gap-4 items-end">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <a href="{{route('laporan.user.pengajuan' ,[
                            ...
                            <a href="{{route('laporan.user.pengajuan_nominal' ,[
                                'from_date' => request('from_date'),
                                'target_date' => request('target_date'),
