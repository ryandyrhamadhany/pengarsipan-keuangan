    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            <div class="space-y-4 bg-white p-4 rounded-lg border border-gray-200 shadow-md">
                ...
                {{-- ================= HERO SECTION ================= --}}
                <div class="bg-gradient-to-b from-[#003A8F] to-[#002766] rounded-xl shadow-md overflow-hidden">
                    <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Tips --}}
                    <div
                        class="bg-gradient-to-br from-green-50 to-emerald-100/50 rounded-xl p-6 border border-green-200 shadow-md">
                    ...
                    {{-- Status Info --}}
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-100/50 rounded-xl p-6 border border-blue-200 shadow-md">
                        <div class="flex items-center gap-3 mb-4">
