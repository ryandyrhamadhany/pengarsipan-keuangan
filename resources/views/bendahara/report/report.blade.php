                ...
                <div class="p-8 space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid md:grid-cols-3 gap-4">
                            <a href="{{route('report.bendahara.all')}}" class="group p-6 bg-white border-2 border-gray-200 rounded-md hover:border-blue-500 hover:shadow-md transition-all duration-200">
                            ...
                            <a href="{{route('report.bendahara.nominal')}}" class="group p-6 bg-white border-2 border-gray-200 rounded-md hover:border-green-500 hover:shadow-md transition-all duration-200">
                                <div class="flex items-start space-x-4">
                            ...
                            <a href="{{route('report.bendahara.sign')}}" class="group p-6 bg-white border-2 border-gray-200 rounded-md hover:border-indigo-500 hover:shadow-md transition-all duration-200">
                                <div class="flex items-start space-x-4">
