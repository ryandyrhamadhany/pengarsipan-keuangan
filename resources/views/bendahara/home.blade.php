<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-2 lg:px-4">
            <div class="space-y-4 bg-gray-50 p-4 border border-gray-100 rounded-md shadow-md">
                ...
                <div class="bg-white border rounded-xl p-6 shadow-md">
                    ...
                    <div x-data="{ progress: {{ $progress ?? 0 }} }" class="h-2 bg-emerald-500 rounded-full" :style="`width: ${progress}%`">
                    </div>
