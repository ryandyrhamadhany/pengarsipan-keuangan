...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\1. Project Repository\pengarsipan-keuangan\public\storage' => 'string',
...
'database.connections.mysql.prefix','database.connections.mysql.prefix_indexes','database.connections.mysql.strict','database.connections.mysql.engine','database.connections.mysql.timezone',
...
'filesystems.disks.private.visibility','filesystems.links.D:\\1. Project Repository\\pengarsipan-keuangan\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','pdf.mode','pdf.format','pdf.default_font_size',
'pdf.default_font','pdf.margin_left','pdf.margin_right','pdf.margin_top','pdf.margin_bottom',
'pdf.margin_header','pdf.margin_footer','pdf.orientation','pdf.title','pdf.subject',
'pdf.author','pdf.watermark','pdf.show_watermark','pdf.show_watermark_image','pdf.watermark_font',
'pdf.display_mode','pdf.watermark_text_alpha','pdf.watermark_image_path','pdf.watermark_image_alpha','pdf.watermark_image_size',
'pdf.watermark_image_position','pdf.custom_font_dir','pdf.custom_font_data','pdf.auto_language_detection','pdf.temp_dir',
'pdf.pdfa','pdf.pdfaauto','pdf.use_active_forms','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'dashboard','admin.dashboard','keuangan.dashboard',
'bendahara.dashboard','PPSPM.dashboard','user.dashboard','kepala.dashboard','profile.edit',
'profile.update','profile.destroy','notifications.index','notifications.read','notifications.readAll',
'notifications.delete','notifications.deleteRead','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','submit.index','submit.create','submit.store',
'submit.show','submit.edit','submit.update','submit.destroy','submit.fixing',
'verification.search','verification.index','verification.create','verification.store','verification.show',
'verification.edit','verification.update','verification.destroy','final.search','final.index',
'final.create','final.store','final.show','final.edit','final.update',
'final.destroy','validation.search','validation.return','validation.index','validation.create',
'validation.store','validation.show','validation.edit','validation.update','validation.destroy',
'file.stream','file.download','file.access.metadata','archive.digital.stream','archive.digital.download',
'archive.stream','archive.download','arsip.index','arsip.create','arsip.store',
'arsip.show','arsip.edit','arsip.update','arsip.destroy','cabinet.index',
'cabinet.create','cabinet.store','cabinet.show','cabinet.edit','cabinet.update',
'cabinet.destroy','category.index','category.create','category.store','category.show',
'category.edit','category.update','category.destroy','subcategory.index','subcategory.create',
'subcategory.store','subcategory.show','subcategory.edit','subcategory.update','subcategory.destroy',
'year.index','year.create','year.store','year.show','year.edit',
'year.update','year.destroy','rack.index','rack.create','rack.store',
'rack.show','rack.edit','rack.update','rack.destroy','folder.index',
'folder.create','folder.store','folder.show','folder.edit','folder.update',
'folder.destroy','digital.index','digital.create','digital.store','digital.show',
'digital.edit','digital.update','digital.destroy','archive.index','archive.create',
'archive.store','archive.show','archive.edit','archive.update','archive.destroy',
'admin.search','admin.archive','admin.kelola','admin.envi','admin.report',
'admin.report_account','admin.report_status','user.monitoring','user.report','laporan.user.pengajuan',
'laporan.user.pengajuan_nominal','keuangan.input','keuangan.checkandupate','keuangan.report','keuangan.report.semua_pengajuan',
'keuangan.report.pengajuan_diverifikasi','bendahara.sign','bendahara.verification','bendahara.report','bendahara.report_sign',
'bendahara.report_sign_nominal','bendahara.report_sign_all','kepala.report','kepala.report_aktif','kepala.report_approved',
'file.index','file.create','file.store','file.show','file.edit',
'file.update','file.destroy','account.index','account.create','account.store',
'account.show','account.edit','account.update','account.destroy','payment.index',
'payment.create','payment.store','payment.show','payment.edit','payment.update',
'payment.destroy','funding.index','funding.create','funding.store','funding.show',
'funding.edit','funding.update','funding.destroy','pengajuan.index','pengajuan.create',
'pengajuan.store','pengajuan.show','pengajuan.edit','pengajuan.update','pengajuan.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'admin.admin-dashboard','admin.input_archive.category.category_show','admin.input_archive.sub_category.year_sub','admin.input_archive.sub_category.year_sub_create','admin.kelola_user.kelola_user',
'admin.kelola_user.user_create','admin.kelola_user.user_edit','admin.report.count_account_submission','admin.report.count_status','admin.report.report',
'admin.search.search_result','admin.setting_environment.funding-sources_create','admin.setting_environment.funding-sources_edit','admin.setting_environment.payment_methods_create','admin.setting_environment.payment_methods_edit',
'admin.setting_environment.setting_environment','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','bendahara.dashboard','bendahara.digital_arsip.all-digital-archive','bendahara.digital_arsip.digital_archive',
'bendahara.digital_arsip.year-archive','bendahara.partials.list-pengajuan','bendahara.report.report','bendahara.report.report_all_sign_submission','bendahara.report.report_submission_sign',
'bendahara.report.report_submission_sign_nominal','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.modal','components.nav-link',
'components.nav-link-sidebar','components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input',
'dashboard','features.arsip.archive.archive-file','features.arsip.archive.archive-file-edit-form','features.arsip.archive.archive-show-file','features.arsip.archive.form-create-file',
'features.arsip.cabinet.cabinet','features.arsip.cabinet.cabinet_create','features.arsip.cabinet.cabinet_edit','features.arsip.category.category','features.arsip.category.category-create',
'features.arsip.category.category-edit','features.arsip.category.category_list','features.arsip.digital_archive.digital_archives_form_create','features.arsip.digital_archive.digital_archives_form_edit','features.arsip.digital_archive.show-digital-archive',
'features.arsip.folder.archive-folder','features.arsip.folder.form-create-folder','features.arsip.folder.form-edit-folder','features.arsip.rack.archive-rack','features.arsip.rack.rack_create',
'features.arsip.rack.rack_edit','features.arsip.sub_category.sub_category','features.arsip.sub_category.sub_category_create','features.arsip.sub_category.sub_category_edit','features.arsip.year.year',
'features.arsip.year.year_create','features.arsip.year.year_edit','features.pengajuan.pengajuan','features.pengajuan.pengajuan-edit','features.pengajuan.pengajuan-show',
'features.pengajuan.submit_monitoring','features.verifikasi.check-pengajuan','features.verifikasi.list_verifikasi','features.verifikasi.search_result','features.verifikasi_final.final_verifikasi_check',
'features.verifikasi_final.list_verifikasi_final','features.verifikasi_final.search_result','features.verifikasi_ppspm.list_verifikasi_ppspm','features.verifikasi_ppspm.ppspm_verifikasi_check','features.verifikasi_ppspm.search_result',
'kepala_kantor.dashboard','kepala_kantor.report.report','kepala_kantor.report.report_approved','kepala_kantor.report.report_arsip_aktif','keuangan.dashboard',
'keuangan.partials.list-pengajuan','keuangan.report.all_submission_report','keuangan.report.report','keuangan.report.verify_submission','layouts.app',
'layouts.guest','layouts.navigation','layouts.sidebar','notifications.index','ppspm.dashboard',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','user.report.report',
'user.report.submission_nominal_report','user.report.submission_report','user.user-dashboard','welcome','laravel-exceptions-renderer::components.badge',
...
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.1. Project Repository.pengarsipan-keuangan.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','AWS_ACCESS_KEY_ID',
